...
if(args.has("target")&&args.has("referer"))
{
	...
	closetimer=()=>brws.storage.local.get(["crowd_close_delay"],res=>timer("crowdCloseTimer",res.crowd_close_delay,true,()=>{
	...
	brws.storage.local.get(["crowd_open_delay"],res=>opentimer=timer("crowdBypassedTimer",res.crowd_open_delay,true,()=>{
