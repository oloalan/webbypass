...
brws.storage.local.get(["disable","navigation_delay","no_tracker_bypass","no_instant_navigation_trackers","allow_ip_loggers","crowd_bypass","crowd_open_delay","crowd_close_delay","no_info_box"],res=>{
	if(res==undefined)
	{
		res={}
	}
	...
	navigationDelayCheckbox.onchange=function()
	{
		...
		brws.storage.local.set({navigation_delay})
		if(this.checked)
		{
	...
	crowdOpenDelayCheckbox.onchange=function()
	{
		...
		brws.storage.local.set({crowd_open_delay})
		crowdOpenDelayLogic()
	}
	...
	crowdCloseDelayCheckbox.onchange=function()
	{
		...
		brws.storage.local.set({crowd_close_delay})
		crowdCloseDelayLogic()
	}
